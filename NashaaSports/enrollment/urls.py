...
urlpatterns = [
    ...
    path("enroll/<int:program_id>/", views.enroll_in_program_view, name="enroll_in_program_view"),
    ...
    path("delete/enrollment/<int:enrollment_id>", views.remove_enrollment_from_cart, name="remove_enrollment_from_cart"),
